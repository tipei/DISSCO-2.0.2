...
Iterator<m_value_type> LinearInterpolator::valueIterator()
{
    ...
    if (size() == 1)
    {
        lii->append(lastTime,lastTime,lastValue,lastValue,long( getDuration() * getSamplingRate() ));
    }
...
//----------------------------------------------------------------------------//
interpolation_type LinearInterpolator::getType()
{
  return LINEAR;
}
...
Iterator<m_value_type> ExponentialInterpolator::valueIterator()
{
    ...
    if (size() == 1)
    {
        eii->append(lastTime,lastTime,lastValue,lastValue,long( getDuration() * getSamplingRate() ));
    }
...
//----------------------------------------------------------------------------//
interpolation_type ExponentialInterpolator::getType()
{
  return EXPONENTIAL;
}
...
Iterator<m_value_type> CubicSplineInterpolator::valueIterator()
{
    ...
    if (size() == 1)
    {
        csii->append(lastTime,lastTime,lastValue,lastValue,long( getDuration() * getSamplingRate() ));
    }
...
//----------------------------------------------------------------------------//
interpolation_type CubicSplineInterpolator::getType()
{
  return CUBIC_SPLINE;
}
