...
public:
    ...
    **/
    InterpolatorEntry(m_time_type t, m_value_type v)
      :time_(t), value_(v) {}
...
/**
*  This is an abstract interpolator class from which more specific interpolators
*  (DynamicVariables used for interpolating between points) can be derived.
*
