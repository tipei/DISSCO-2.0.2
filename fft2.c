/***************************************************************************
 ...
 Changes:
   02/11/18  jwb  Changed fft2 declaration to fit C99 preferred syntax
 **************************************************************************/
...
//     float *a     real values of input float array
//     float *b     imaginary values of input float array and returned
//                  output array. (fft2 will zero for forward transform) 
//     int m	    log(base 2) of the array lengths minus 1
//                  e.g., 7 for length 256, 9 for length 1024.
//     float dx     sampling period (one over sample rate)
//     int inverse  0 for forward transform, 1 for inverse transform
{
