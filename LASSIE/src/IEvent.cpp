...
std::string IEvent::getEventName() { return eventName; }

EventType IEvent::getEventType() { return eventType; }
...
std::string IEvent::getTimeSignatureEntry2() { return timeSignatureEntry2; }

int IEvent::getTempoMethodFlag() { return tempoMethodFlag; }

void IEvent::setTempoMethodFlag(int _flag) {
    tempoMethodFlag = _flag;
    changedButNotSaved = true;
}
TempoPrefix IEvent::getTempoPrefix() { return tempoPrefix; }
...
TempoNoteValue IEvent::getTempoNoteValue() { return tempoNoteValue; }
...
std::string IEvent::getChildEventDefEntry3() { return childEventDefEntry3; }
...
int IEvent::getFlagChildEventDef() { return flagChildEventDef; }
...
int IEvent::getFlagChildEventDefStartType() { return flagChildEventDefStartType; }
...
std::string EventLayer::getByLayer() { return byLayer; }
...
IEvent::EventExtraInfo* IEvent::getEventExtraInfo() { return extraInfo; }

void IEvent::SoundExtraInfo::setDeviation(std::string _deviation) { deviation = _deviation; }

std::string IEvent::SoundExtraInfo::getDeviation() { return deviation; }

void IEvent::SoundExtraInfo::setSpectrumGenBuilder(std::string _string) {
    spectrumGenBuilder = _string;
}

std::string IEvent::SoundExtraInfo::getSpectrumGenBuilder() { return spectrumGenBuilder; }
...
void IEvent::BottomEventExtraInfo::setFrequencyFlag(int _flag) { frequencyFlag = _flag; }
...
std::string IEvent::BottomEventExtraInfo::getFrequencyEntry1() { return frequencyEntry1; }

void IEvent::BottomEventExtraInfo::setFrequencyEntry1(std::string _string) {
    frequencyEntry1 = _string;
}
std::string IEvent::BottomEventExtraInfo::getFrequencyEntry2() { return frequencyEntry2; }

void IEvent::BottomEventExtraInfo::setFrequencyEntry2(std::string _string) {
    frequencyEntry2 = _string;
}
std::string IEvent::BottomEventExtraInfo::getLoudness() { return loudness; }
void IEvent::BottomEventExtraInfo::setLoudness(std::string _string) { loudness = _string; }
std::string IEvent::BottomEventExtraInfo::getSpatialization() { return spatialization; }
void IEvent::BottomEventExtraInfo::setSpatialization(std::string _string) {
    spatialization = _string;
}
std::string IEvent::BottomEventExtraInfo::getReverb() { return reverb; }
void IEvent::BottomEventExtraInfo::setReverb(std::string _string) { reverb = _string; }
...
int EventBottomModifier::getApplyHowFlag() { return applyHowFlag; }
...
std::string IEvent::EnvelopeExtraInfo::getEnvelopeBuilder() { return envelopeBuilder; }
...
void IEvent::ReverbExtraInfo::setReverbBuilder(std::string _string) { reverbBuilder = _string; }

std::string IEvent::ReverbExtraInfo::getReverbBuilder() { return reverbBuilder; }

void IEvent::FilterExtraInfo::setFilterBuilder(std::string _string) { filterBuilder = _string; }

std::string IEvent::FilterExtraInfo::getFilterBuilder() { return filterBuilder; }

void IEvent::MeasureExtraInfo::setMeasureBuilder(std::string _string) { measureBuilder = _string; }

std::string IEvent::MeasureExtraInfo::getMeasureBuilder() { return measureBuilder; }

void IEvent::SieveExtraInfo::setSieveBuilder(std::string _string) { sieveBuilder = _string; }

std::string IEvent::SieveExtraInfo::getSieveBuilder() { return sieveBuilder; }

void IEvent::PatternExtraInfo::setPatternBuilder(std::string _string) { patternBuilder = _string; }

std::string IEvent::PatternExtraInfo::getPatternBuilder() { return patternBuilder; }
...
std::string EventLayer::getXMLString() {
    ...
    string stringBuffer = "        <Layer>\n";
    stringBuffer = stringBuffer + "          <ByLayer>" + byLayer +
                   "</ByLayer>\n"
                   "          <DiscretePackages>\n" +
                   packageBuffer +
                   "          </DiscretePackages>\n"
...
std::string EventDiscretePackage::getLASSIEMetadataString() {
    ...
    std::string a = "<`" + event->getEventName() + "`," + string(charBuffer) +
                    ",`"  // this is eventType
                    + weight + "`,`" + attackEnv + "`,`" + attackEnvScale + "`,`" + durationEnv +
                    "`,`" + durationEnvScale + "`>";
...
void IEvent::addParent(IEvent* _event) { parents.push_back(_event); }
...
IEvent::IEvent(IEvent* _original, string _newName) {
    ...
    if (eventType == eventBottom) {
        ...
        extraInfo = (EventExtraInfo*)new FilterExtraInfo((FilterExtraInfo*)_original->extraInfo);
    } else if (eventType == eventMea) {
        extraInfo = (EventExtraInfo*)new MeasureExtraInfo((MeasureExtraInfo*)_original->extraInfo);
    } else if (eventType == eventSiv) {
        extraInfo = (EventExtraInfo*)new SieveExtraInfo((SieveExtraInfo*)_original->extraInfo);
    } else if (eventType == eventEnv) {
        extraInfo =
            (EventExtraInfo*)new EnvelopeExtraInfo((EnvelopeExtraInfo*)_original->extraInfo);
    } else if (eventType == eventSpa) {
        extraInfo = (EventExtraInfo*)new SpatializationExtraInfo(
...
IEvent::NoteExtraInfo::NoteExtraInfo(NoteExtraInfo* _original) { modifiers = _original->modifiers; }
...
int IEvent::getEventOrderInPalette() { return eventOrderInPalette; }
...
void IEvent::makeSuperColliderCode() {
    /*TODO::
      1. collect the string of all the necessary global settings (such as
      envelope library, etc) so we probably want to go to EnvelopeLibraryWindow
      and make a function like: string outputSCEnvelopeCode(){
            //go through every envelope entry

         }
         and in EnvelopeLibraryEntry class, make a function to actually generate
      the SC code.

      2. attach the string of the setting of this event to the global settings,
      and then output it to a file (maybe take a look of IEvent::saveAsTHMLB() )
...
string IEvent::getXMLTHMLB() {
    ...
    string stringbuffer = "    <Event orderInPalette='" + string(charBuffer) +
                          ...
                          "</DurationSieve>\n"
                          "        <DefinitionFlag>" +
                          flagChildEventDefChar +
                          "</DefinitionFlag>\n"
                          "        <StartTypeFlag>" +
                          flagChildEventDefStartTypeChar +
                          "</StartTypeFlag>\n"
                          "        <DurationTypeFlag>" +
                          flagChildEventDefDuratonTypeChar +
                          "</DurationTypeFlag>\n"
                          "      </ChildEventDefinition>\n"
                          "      <Layers>\n" +
                          layerbuffer +
    ...
    if (eventType == eventBottom) {
        ...
        bottomBuffer = bottomBuffer +
                       ...
                       frequencyFlagChar +
                       "</FrequencyFlag>\n"
                       "          <FrequencyContinuumFlag>" +
                       frequencyContinuumFlagChar +
                       "</FrequencyContinuumFlag>\n"
                       "          <FrequencyEntry1>" +
...
string IEvent::getXMLSound() {
    ...
    string buffer = "    <Event orderInPalette='" + string(orderInPaletteChar) +
                    "'>\n"
                    ...
                    "</Deviation>\n"
                    "      <GenerateSpectrum>" +
                    extraInfo->getSpectrumGenBuilder() +
                    "</GenerateSpectrum>\n"
                    "      <Spectrum>\n" +
...
string IEvent::getXMLEnv() {
    ...
    string buffer = "    <Event orderInPalette='" + string(charBuffer) +
                    "'>\n"
...
string IEvent::getXMLSpa() {
    ...
    string buffer = "    <Event orderInPalette='" + string(charBuffer) +
                    ...
                    eventName +
                    "</Name>\n"
                    "      <SpatializationBuilder>" +
                    extraInfo->getSpatializationBuilder() +
                    "</SpatializationBuilder>\n"
                    "    </Event>\n";
...
IEvent::BottomEventExtraInfo::BottomEventExtraInfo(int _childTypeFlag, DOMElement* _thisElement) {
    ...
    if (temp != NULL) {  // in case there is no <Filter></Filter>
        ...
        modifiers = buildModifiersFromDOMElement(
            thisElement->getNextElementSibling()->getFirstElementChild());
    } else {
        filter = "";
...
EventBottomModifier* IEvent::BottomEventExtraInfo::buildModifiersFromDOMElement(
    ...
    currentModifier->next =
        buildModifiersFromDOMElement(_thisModifierElement->getNextElementSibling());
