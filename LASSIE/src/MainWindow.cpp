...
MainWindow::MainWindow() {
    ...
    menuRefActionGroup->add(Gtk::Action::create("FileNewObject", Gtk::Stock::ADD,
                                                "_Create a new Object", "Create a new object"),
                            Gtk::AccelKey("<alt>N"),
    ...
    menuRefActionGroup->add(
        Gtk::Action::create("FileOpen", Gtk::Stock::OPEN, "_Open an existing project",
    ...
    /*
      menuRefActionGroup->add(
        Gtk::Action::create("OpenProjectOldFormat", "Open Project in Old
      Format"), sigc::mem_fun(*this, &MainWindow::menuFileOpen));
    */

    menuRefActionGroup->add(Gtk::Action::create("FileSaveAs", Gtk::Stock::SAVE_AS),
                            sigc::mem_fun(*this, &MainWindow::menuFileSaveAs));

    menuRefActionGroup->add(Gtk::Action::create("FileClose", Gtk::Stock::CLOSE),
                            sigc::mem_fun(*this, &MainWindow::menuFileClose));

    menuRefActionGroup->add(Gtk::Action::create("FilePrint", Gtk::Stock::PRINT),
                            sigc::mem_fun(*this, &MainWindow::menuFilePrint));

    menuRefActionGroup->add(Gtk::Action::create("FileQuit", Gtk::Stock::QUIT),
                            sigc::mem_fun(*this, &MainWindow::menuFileQuit));

    // Edit and its sub-menu
    menuRefActionGroup->add(Gtk::Action::create("EditMenu", "Edit"));

    menuRefActionGroup->add(Gtk::Action::create("EditUndo", Gtk::Stock::UNDO),
                            sigc::mem_fun(*this, &MainWindow::menuEditUndo));

    menuRefActionGroup->add(Gtk::Action::create("EditRedo", Gtk::Stock::REDO),
                            sigc::mem_fun(*this, &MainWindow::menuEditUndo));

    menuRefActionGroup->add(Gtk::Action::create("EditCut", Gtk::Stock::CUT),
                            sigc::mem_fun(*this, &MainWindow::menuEditCut));

    menuRefActionGroup->add(Gtk::Action::create("EditCopy", Gtk::Stock::COPY),
                            sigc::mem_fun(*this, &MainWindow::menuEditCopy));

    menuRefActionGroup->add(Gtk::Action::create("EditPaste", Gtk::Stock::PASTE),
                            sigc::mem_fun(*this, &MainWindow::menuEditPaste));

    menuRefActionGroup->add(Gtk::Action::create("EditSelectAll", Gtk::Stock::SELECT_ALL),
                            sigc::mem_fun(*this, &MainWindow::menuEditSelectAll));

    menuRefActionGroup->add(Gtk::Action::create("EditPreferences", Gtk::Stock::PREFERENCES),
                            sigc::mem_fun(*this, &MainWindow::menuEditSelectAll));

    // Project Menu
    menuRefActionGroup->add(Gtk::Action::create("ProjectMenu", "Project"));

    menuRefActionGroup->add(Gtk::Action::create("ProjectProperties", Gtk::Stock::PROPERTIES),
                            sigc::mem_fun(*this, &MainWindow::menuProjectProperties));

    menuRefActionGroup->add(Gtk::Action::create("Synthesize", "Synthesize"),
    ...
    */
    ...
    menuRefActionGroup->add(Gtk::Action::create("HelpContents", Gtk::Stock::HELP, "Contents"),
                            sigc::mem_fun(*this, &MainWindow::menuHelpContents));

    menuRefActionGroup->add(Gtk::Action::create("HelpAbout", Gtk::Stock::ABOUT),
...
void MainWindow::menuFileClose() { FileOperations::close(this); }
...
////////////////////////////////////////////////////////////////////////////////
void MainWindow::menuHelpContents() { HelpOperations::showContents(); }

//-----------------------------------------------------------------------------

void MainWindow::menuHelpAbout() { HelpOperations::showAbout(); }

//-----------------------------------------------------------------------------

void MainWindow::changeCurrentProjectViewTo(ProjectViewController* _newProject) {
...
void MainWindow::includeUi_info(Glib::ustring pathAndName, Glib::ustring ctrl) {
    if (ctrl == "add") {
        ...
        ui_info_action = ui_info_action + "<menuitem action='" + pathAndName + "'/>";

        ui_info = ui_info_befor + ui_info_action + ui_info_after;

        menuRefActionGroup->add(Gtk::Action::create(pathAndName, pathAndName),
...
void MainWindow::menuProjectProperties() { projectView->setProperties(); }
...
void MainWindow::showEnvelopeLibraryWindow() { envelopeLibraryWindow->show(); }

void MainWindow::showMarkovModelLibraryWindow() { markovModelLibraryWindow->show(); }
...
void MainWindow::menuProjectSynthesize() {
    ...
    if (result == 1 && projectView) {
        ...
        // YY_BUFFER_STATE newParserBuffer = yy_create_buffer (
        // yyin,YY_BUF_SIZE);
...
void MainWindow::menuProjectGenerateSCFile() { projectView->getTop()->makeSuperColliderCode(); }
