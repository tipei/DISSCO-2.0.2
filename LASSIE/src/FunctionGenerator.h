...
public:
    ...
    list<std::string> static fileValueListToStringList(list<FileValue> _valueList,
                                                       FunctionReturnType _returnType);
    std::string static stringListToString(list<std::string> _list);
    std::string static fileValueListToString(list<FileValue> _valueList,
                                             FunctionReturnType _returnType);
...
private:
    ...
    std::string result;
    FunctionReturnType returnType;  // store the type the generator should
                                    // return
