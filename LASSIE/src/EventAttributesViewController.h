...
private:
    ...
    public:
        ...
        void renderWeight(Gtk::CellRenderer* renderer, const Gtk::TreeModel::iterator& iter);

        void renderAttackEnv(Gtk::CellRenderer* renderer, const Gtk::TreeModel::iterator& iter);

        void renderAttackEnvScale(Gtk::CellRenderer* renderer,
                                  const Gtk::TreeModel::iterator& iter);

        void renderDurationEnv(Gtk::CellRenderer* renderer, const Gtk::TreeModel::iterator& iter);

        void renderDurationEnvScale(Gtk::CellRenderer* renderer,
                                    const Gtk::TreeModel::iterator& iter);

        void saveWeight(const Glib::ustring& path_string, const Glib::ustring& new_text);

        void saveAttackEnv(const Glib::ustring& path_string, const Glib::ustring& new_text);

        void saveAttackEnvScale(const Glib::ustring& path_string, const Glib::ustring& new_text);

        void saveDurationEnv(const Glib::ustring& path_string, const Glib::ustring& new_text);

        void saveDurationEnvScale(const Glib::ustring& path_string, const Glib::ustring& new_text);
    };
