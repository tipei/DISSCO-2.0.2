...
public:
    ...
    // after open project and constructing all the event, has to link them
    // properly
...
private:
    ...
    // EventExtraInfo* openExtraInfo(EventFactory* _event ,EventType
    // _eventType);
