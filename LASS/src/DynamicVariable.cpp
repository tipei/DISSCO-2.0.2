...
//----------------------------------------------------------------------------//
void DynamicVariable::setDuration(m_time_type duration)
{
    duration_ = duration;
}

//----------------------------------------------------------------------------//
m_time_type DynamicVariable::getDuration()
{
    return duration_;
}
...
//----------------------------------------------------------------------------//
void DynamicVariable::setSamplingRate(m_rate_type rate)
{
    rate_ = rate;
}

//----------------------------------------------------------------------------//
m_rate_type DynamicVariable::getSamplingRate()
{
    return rate_;
}
