 ...
 *http://www.musicdsp.org/files/Audio-EQ-Cookbook.txt. low pass filter, High
 *pass filter,band pass filter , Notch Filter , Peaking band EQ filter, Low
 *shelf filter, High shelf filters are implemented author Mert Bay
 **/
