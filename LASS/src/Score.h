/* LASS (additive sound synthesis library) Copyright (C) 2005  Sever Tipei
(s-tipei@uiuc.edu) Modified by Ming-ching Chiu 2013
...
public:
    ...
    /**
     * Worker threads give the renderedSound back to the main thread to
     *compositie
     **/
     ...
     **/
    enum ClippingManagementMode { NONE, CLIP, SCALE, CHANNEL_SCALE, ANTICLIP, CHANNEL_ANTICLIP };
