 ...
 *
 * \note The Filter objects are stateful machines with internal feedback
 *mechanisms.  Thus this filter should be allocated anew each time you begin a
 *new channel and should not be mixed between channels. \author Jim Lindstrom
 **/
class Filter {
public:
    virtual ~Filter() {}
