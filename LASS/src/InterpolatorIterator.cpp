...
//----------------------------------------------------------------------------//
InterpolatorIterator::InterpolatorIterator() : stepsLeft_(0) {}

//----------------------------------------------------------------------------//
void InterpolatorIterator::append(m_time_type t_from, m_time_type t_to, m_value_type v_from,
                                  m_value_type v_to, m_sample_count_type steps) {
...
CubicSplineInterpolatorIterator::CubicSplineInterpolatorIterator() : x0(-1), y0(-1), x3(0), y3(0) {}
