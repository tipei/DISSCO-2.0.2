...
//----------------------------------------------------------------------------//
template <class T>
void Collection<T>::add(int index, const T& element) {
...
//----------------------------------------------------------------------------//
template <class T>
T Collection<T>::remove(int index) {
    if ((index >= 0) && (index < (int)vector_.size())) {
        // get an iterator pointing at the index
        typename vector<T>::iterator it = vector_.begin();
        for (int i = 0; i < index; i++) it++;
...
//----------------------------------------------------------------------------//
template <class T>
T Collection<T>::set(int index, const T& element) {
    if ((index >= 0) && (index < (int)vector_.size())) {
        T old = vector_[index];
...
//----------------------------------------------------------------------------//
template <class T>
void Collection<T>::sortCollection() {
...
//----------------------------------------------------------------------------//
template <class T>
Collection<T>::CollectionIterator ::CollectionIterator(typename vector<T>::iterator it,
                                                       typename vector<T>::iterator end)
    : it_(it), end_(end) {}

//----------------------------------------------------------------------------//
template <class T>
typename Collection<T>::CollectionIterator* Collection<T>::CollectionIterator::clone() {
    return new CollectionIterator(it_, end_);
}

//----------------------------------------------------------------------------//
template <class T>
bool Collection<T>::CollectionIterator::hasNext() {
    return (it_ < end_);
}

//----------------------------------------------------------------------------//
template <class T>
T& Collection<T>::CollectionIterator::next() {
    T& value = *it_;
    it_++;
    return value;
}
...
template <class T>
void Collection<T>::printPointers(char* collType) {
    // get an iterator pointing at the index
    cout << collType << ": " << endl;
