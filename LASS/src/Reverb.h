...
public:
     ...
     *  sound.
     * @param hilow_spread in most rooms the low frequecy response will be
     *higher than the high frequency response.  If we hold other parameters
     ...
     *   will assume on any data it is fed
     **/
    Reverb(Envelope *percentReverb, float hilow_spread, float gainAllPass, float delay,
     ...
     *   will assume on any data it is fed
     **/
    Reverb(Envelope *percentReverb, float *combGainList, float *lpGainList, float gainAllPass,
     ...
     *   will assume on any data it is fed
     **/
    void ConstructorCommon(Envelope *percentReverb, float *combGainList, float *lpGainList,
     ...
     * are partially dependent on old data sent to Reverb.  In order to clear
     *out the history in these filters, call Reverb::Reset before reusing a
     *Reverb object
     **/
    void reset(void);
    /**
