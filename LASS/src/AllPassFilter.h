 ...
 *internal feedback mechanisms.  Thus this filter should be reset() each time
 *you begin a new channel and should not be mixed between channels. \author
 *Andrew Kurtz \author Jim Lindstrom
 **/
