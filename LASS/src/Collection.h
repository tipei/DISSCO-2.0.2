...
public:
     ...
     *	\note only use this function if template type of this collection has
     *well defined operator< , operator== , and operator> . Examples of this are
     *standard types like int and float, as well as custom types like
     *LinearInterpolatorEntry.
     **/
    void sortCollection();
