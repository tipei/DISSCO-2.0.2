 ...
 *    using an envelope for reverb that starts at zero, climbs to 1 at the middle
 *    and goes back to zero for the ending, playing the same sound every 2 seconds.
 *    
 **/
...
int main (int argc, const char * argv[]) {
  ...
  //  this doesn't ever get used to pan, it's just a leftover and will become the reverb envelope below
