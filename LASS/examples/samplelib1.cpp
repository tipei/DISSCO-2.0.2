...
int main(int argc, const char* argv[]) {
    ...
    cout << "Adding library entry: " << envlib.addEnvelope(xyPointCollection, segmentCollection)
         << "\n";
    ...
    */
    ...
    // saveLibrary() returns true if the library is saved properly, false
    // otherwise
    cout << "Library written (1=OK): " << verify << "\n";

    // display the added envelopes using size() to find the upper library index
    // bound
