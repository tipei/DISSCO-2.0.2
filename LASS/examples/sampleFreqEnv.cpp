...
int main (int argc, const char * argv[]) {
    ...
    // create envelopes:
    xy.x = 0.0; xy.y = 1.0; xyPointCollection.add(xy);
    xy.x = 1.0; xy.y = 1.1; xyPointCollection.add(xy);
    seg.interType = LINEAR; seg.lengthType = FLEXIBLE; seg.timeValue = 1.0;
    ...
    xyPointCollection.clear(); segmentCollection.clear();

    xy.x = 0.0; xy.y = 1.0; xyPointCollection.add(xy);
    xy.x = 1.0; xy.y = 0.6; xyPointCollection.add(xy);
    seg.interType = LINEAR; seg.lengthType = FLEXIBLE; seg.timeValue = 1.0;
    segmentCollection.add(seg);
    ...
    xy.x = 0.0; xy.y = 1.0; xyPointCollection.add(xy);
    xy.x = 1.0; xy.y = 1.5; xyPointCollection.add(xy);
    seg.interType = LINEAR; seg.lengthType = FLEXIBLE; seg.timeValue = 1.0;
    segmentCollection.add(seg);
    ...
    xy.x = 0.0; xy.y = 1.0; xyPointCollection.add(xy);
    xy.x = 1.0; xy.y = 0.9; xyPointCollection.add(xy);
    seg.interType = LINEAR; seg.lengthType = FLEXIBLE; seg.timeValue = 1.0;
    segmentCollection.add(seg);
    ...
    seg.interType = LINEAR; seg.lengthType = FLEXIBLE; seg.timeValue = 0.1;
    segmentCollection.add(seg);
    seg.interType = EXPONENTIAL; seg.lengthType = FLEXIBLE; seg.timeValue = 0.3;
    segmentCollection.add(seg);
    seg.interType = LINEAR; seg.lengthType = FLEXIBLE; seg.timeValue = 0.6;
    segmentCollection.add(seg);
