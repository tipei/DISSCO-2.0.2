...
int main (int argc, const char * argv[]) {
    ...
    seg.x = 1.1; seg.y = 0.20;
    segmentCollection.add(seg);

    seg.x = 1.2; seg.y = 0.40;
    segmentCollection.add(seg);

    seg.x = 1.7; seg.y = 0.30;
    segmentCollection.add(seg);

    seg.x = 2.0; seg.y = 0.8;
    segmentCollection.add(seg);

    seg.x = 2.2; seg.y = 0.90;
    segmentCollection.add(seg);
    ...
    seg2.x = 0.0; seg.y = 0.0;
    seg2.interType = EXPONENTIAL; seg2.lengthType = FIXED;
    segmentCollection2.add(seg2);

    seg2.lengthType = FLEXIBLE;
    seg2.x = 0.5; seg2.y = 0.8;
    segmentCollection2.add(seg2);

    seg2.lengthType = FIXED;
    seg2.interType = LINEAR;
    seg2.x = 0.8; seg2.y = 0.7;
    segmentCollection2.add(seg2);

    seg2.x = 1.0; seg2.y = 0.50;
    segmentCollection2.add(seg2);

    seg2.x = 1.2; seg2.y = 0.30;
    segmentCollection2.add(seg2);

    seg2.x = 1.87; seg2.y = 0.70;
    segmentCollection2.add(seg2);

    seg2.x = 2.10; seg2.y = 0.45;
    segmentCollection2.add(seg2);

    seg2.x = 2.2; seg2.y = 1.0;
    segmentCollection2.add(seg2);
