...
{
      22,     0,    -1,    23,    -1,    25,    -1,    -1,    23,    24,
      -1,    24,    -1,    33,     9,    -1,    28,     9,    -1,    25,
      26,    -1,    26,    -1,    27,     9,    -1,    19,     4,    29,
      -1,    20,     4,    29,    -1,     5,    -1,    30,    -1,     7,
      -1,    33,    -1,     3,    -1,    11,    32,    10,    -1,    15,
      32,    14,    -1,    29,    -1,    29,    12,    32,    -1,    18,
      31,    -1
};
...
{
       0,   200,   200,   205,   210,   215,   216,   220,   225,   234,
     235,   239,   247,   254,   266,   271,   276,   281,   287,   294,
     301,   308,   314,   325
};
#endif
...
{
  "$end", "error", "$undefined", "SFUNCTOK", "EQUALTOK", "NUMBERTOK",
  "LISTTOK", "STRTOK", "TYPETOK", "SEMITOK", "RBRAC", "LBRAC", "COMMA",
  "SCOLON", "RPAREN", "LPAREN", "RBRACE", "LBRACE", "FUNCTOK",
  "GLOBALKEYWORDTOK", "EVENTKEYWORDTOK", "$accept", "config",
  "one_or_more_eventconfigs", "eventconfig", "one_or_more_globalconfigs",
  "globalconfig", "gstatement", "statement", "arg", "list", "funclist",
  "list_element", "function", 0
};
#endif
...
{
       4,     0,     0,     0,     0,     2,     6,     3,    10,     0,
       0,     0,     0,    23,     0,     0,     1,     5,     9,    11,
       8,     7,    18,    14,    16,     0,    21,    15,     0,    17,
      12,    13,     0,     0,    20,    19,    22
};
...
{
      -7,   -12,    13,    14,    19,    -4,   -25,     1,   -25,    12,
      15,    16,    -3,   -25,    -3,    -3,   -25,   -25,   -25,   -25,
     -25,   -25,   -25,   -25,   -25,    -3,    10,   -25,     9,   -25,
     -25,   -25,    17,    -3,   -25,   -25,   -25
};
...
{
      22,    32,    23,    12,    24,    11,    30,    31,    25,    36,
      11,     1,     2,     3,     1,     1,     3,    14,    15,    16,
       2,    19,    33,    34,    20,    21,    17,    35,     0,    18
};

static const yytype_int8 yycheck[] =
{
       3,    25,     5,    15,     7,     0,    14,    15,    11,    33,
       5,    18,    19,    20,    18,    18,    20,     4,     4,     0,
      19,     9,    12,    14,     9,     9,     5,    10,    -1,     7
};
...
{
       0,    18,    19,    20,    22,    23,    24,    25,    26,    27,
      28,    33,    15,    31,     4,     4,     0,    24,    26,     9,
       9,     9,     3,     5,     7,    11,    29,    30,    32,    33,
      29,    29,    32,    12,    14,    10,    32
};
...
#line 308 "Parser.y"
    { (yyval) = (char*)ToList((FileValue*)(yyvsp[(1) - (1)]));
		     ...
		     printFileValue(TOVALUE((yyval))); printf("\n");
			 #endif
			 ;}
    break;
