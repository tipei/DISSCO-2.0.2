...
public:
     ...
     **/
    void BuildFromExpr(int minVal, int maxVal, const char *eMethod, const char *wMethod,
     ...
     **/
    void Build(int minVal, int maxVal, const char *eMethod, const char *wMethod,
    ...
    /**
     *   This function chooses an element from a list of integers by matching
     *its probability of occurence stored in a corresponding list of doubles
...
private:
     ...
     *  \param offsetVector offset of the elements
     **/
    void Elements(int minVal, int maxVal, const char *method, std::vector<int> eArgVect,
     ...
     **/
    void Weights(std::vector<int> eArgVect, const char *method, std::vector<int> wArgVect,
                 std::vector<int> offsetVect);
     ...
     *  \param offsetVector offset of elements
     **/
    void Multiples(int minVal, int maxVal, std::vector<int> numMods, std::vector<int> offsetVect);
     ...
     **/
    // TODO: you should really pass in value by reference, try change it to
    // other functions
     ...
     *  \param wArgVector vector of ints contains info about weights
     **/
    void HierarchicWeights(const std::vector<int> &eArgVect, std::vector<int> wArgVect,
    ...
    /**
     *  CumulArray.  Takes an array of doubles, divides each element by the sum
     *of all elements, and adds the value to the preceding value (sum of values)
     *so that the values range from 0 to 1.
