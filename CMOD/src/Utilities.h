...
public:
     ...
     * \param _numThreads The number of threads to use in multi-threaded
     *rendering \param _numChannels The number of channels to use \param
     *_samplingRate The sampling rate \param _piece
     **/
    Utilities(DOMElement* _root, string _workingPath, bool _soundSynthesis, bool _outputParticel,
              int _numThreads, int _numChannels, int _samplingRate, Piece* _piece);
...
private:
    ...
    DOMElement* getSPAFunctionElementHelper(void* _object, DOMElement* _SPAFunction,
                                            bool _initialCall);

    // Helpers for getting REV
    DOMElement* getREVFunctionElement(void* _object);
    DOMElement* getREVFunctionElementHelper(void* _object, DOMElement* _REVFunction,
                                            bool _initialCall);

    // Helpers for getting FIL
    DOMElement* getFILFunctionElement(void* _object);
    DOMElement* getFILFunctionElementHelper(void* _object, DOMElement* _FILFunction,
                                            bool _initialCall);
